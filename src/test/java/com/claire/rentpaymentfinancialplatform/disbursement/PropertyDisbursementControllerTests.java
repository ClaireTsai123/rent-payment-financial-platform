...
class PropertyDisbursementControllerTests extends PostgresIntegrationTest {
    ...
    @Test
    void recordsDefinitiveProviderFailureForDisbursement() throws Exception {
        PaymentPlan paymentPlan = paymentPlanRepository.save(newPaymentPlan());
    ...
    @Test
    void recordsAmbiguousProviderTimeoutForDisbursementWithoutFailingOrRetrying() throws Exception {
        PaymentPlan paymentPlan = paymentPlanRepository.save(newPaymentPlan());
